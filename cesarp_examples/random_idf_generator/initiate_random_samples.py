...
def initiate_random_samples(number_of_buildings):
    """
    Randomly generate site vertices and building info for the desired number of buildings
    ...
    generate_centered_buildings_in_grid(grid_root, block_size, min_building_size, max_building_size,
